...
const APP_ID = "amzn1.ask.skill.40334966-c9c1-4f9a-a1ff-2fb6ef48a956"; //Flexa appID
...
const handlers = {
    ...
    'RecipeIntent': function () {
        ...
        var numSlot = this.event.request.intent.slots.Number;
    //    callback = false;
        let itemName;
        ...
        if (recipe) {
            this.attributes.numTimes = numSlot;
...
const languageStrings = {
    ...
    'en-US': {
        translation: {
            ...
            SKILL_NAME: 'Flexa Fitness',
            WELCOME_MESSAGE: "Welcome to %s. You can ask a question like, what\'s my workout for today? ... Now, what can I help you with.",
            WELCOME_REPROMT: 'For instructions on what you can say, please say help me.',
            DISPLAY_CARD_TITLE: '%s  - Recipe for %s.',
            HELP_MESSAGE: "You can ask questions such as, what\'s my workout today, or, you can say exit...Now, what can I help you with?",
            HELP_REPROMT: "You can say things like, what\'s my workout today, or you can say exit...Now, what can I help you with?",
            STOP_MESSAGE: 'Goodbye!',
            RECIPE_REPEAT_MESSAGE: 'Try saying repeat.',
            RECIPE_NOT_FOUND_MESSAGE: "I\'m sorry, I currently do not know ",
            RECIPE_NOT_FOUND_WITH_ITEM_NAME: 'the workout for %s. ',
            RECIPE_NOT_FOUND_WITHOUT_ITEM_NAME: 'that workout. ',
            RECIPE_NOT_FOUND_REPROMPT: 'What else can I help with?',
        },
    },
    'de-DE': {
